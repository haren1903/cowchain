...
@Component({
  ...
  styleUrls: ['./Slaughter.component.css'],
  providers: [SlaughterService]
})
export class SlaughterComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceSlaughter.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceSlaughter.updateParticipant(form.get('id').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceSlaughter.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceSlaughter.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
